...
urlpatterns = [
    ...
    url(r'^optiontypes/((?P<optiontype>[a-zA-Z]+)|(?P<pk>[0-9]+))/$', views.OptionTypeDetail.as_view()),
    url(r'^products/$', views.ProductsList.as_view()),
    url(r'^products/((?P<product>[a-zA-Z]+)|(?P<pk>[0-9]+))/$', views.ProductDetail.as_view()),
    url(r'^categories/$', views.CategoriesList.as_view()),
    url(r'^categories/((?P<category>[a-zA-Z]+)|(?P<pk>[0-9]+))/$', views.CategoryDetail.as_view()),
